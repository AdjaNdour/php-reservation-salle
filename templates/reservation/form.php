...
<div class="card" style="max-width: 680px; margin: 0 auto;">
    <form method="POST" action="/reservations">
        ...
        <div class="form-group">
            ...
            <select id="salle_id" name="salle_id" class="<?= isset($errors['salle_id']) ? 'input-error' : '' ?>" required>
        ...
        <div class="form-group">
            ...
            <input 
                ...
                id="responsable" 
                name="responsable" 
                value="<?= htmlspecialchars($valResponsable) ?>" 
                class="<?= isset($errors['responsable']) ? 'input-error' : '' ?>"
                placeholder="Ex : Dr. Awa Ndiaye"
                required
            >
        ...
        <div class="form-group">
            ...
            <input 
                ...
                placeholder="Ex : awa.ndiaye@universite.sn"
                required
            >
        ...
        <div class="form-group">
            ...
            <textarea 
                ...
                placeholder="Ex : Cours magistral d'architecture logicielle..."
                required
        ...
        <div class="form-group">
            ...
            <input 
                ...
                id="date_debut" 
                name="date_debut" 
                value="<?= htmlspecialchars($valDateDebut) ?>" 
        ...
        <div class="form-group">
            ...
            <input 
                ...
                id="date_fin" 
                name="date_fin" 
                value="<?= htmlspecialchars($valDateFin) ?>" 
