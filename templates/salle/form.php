    ...
    <form method="POST" action="<?= $actionUrl ?>">
        <div class="form-group">
            ...
            <input 
                ...
                id="nom" 
                name="nom" 
                value="<?= htmlspecialchars((string) $valNom) ?>" 
        ...
        <div class="form-group">
            ...
            <input 
                ...
                id="batiment" 
                name="batiment" 
                value="<?= htmlspecialchars((string) $valBatiment) ?>" 
                class="<?= isset($errors['batiment']) ? 'input-error' : '' ?>"
                placeholder="Ex : Bâtiment Sciences, Bâtiment B..."
                required
            >
        ...
        <div class="form-group">
            ...
            <input 
                ...
                min="1" 
                max="1000" 
                value="<?= htmlspecialchars((string) $valCapacite) ?>" 
                class="<?= isset($errors['capacite']) ? 'input-error' : '' ?>"
                placeholder="Ex : 40"
                required
            >
        ...
        <div class="form-group">
            ...
            <select id="type" name="type" class="<?= isset($errors['type']) ? 'input-error' : '' ?>" required>
